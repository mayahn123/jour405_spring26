...
md_cities_percentiles <- md_cities_rates |>
  mutate(violent_rate_2020_percentile = ntile(violent_rate_2020, 100))
md_cities_rates |>
  summarise(IQR_violent_2020 = IQR(violent_rate_2020))

```
Do the results change your best story idea from the previous assignment? Why or why not?
I think the results do provide other ideas that could be good to pursue. I think it would be interesting to cover why Ocean City, which is in the 100th percentile for violent crime, has such high rates. Ocean City has a very high crime rate compared to its population. However, I do think it is still important to cover Baltimore City's high crime because it recorded the greatest number of total violent incidents in 2020. 
