...
**Describe the shape of the distribution. Is it roughly normal? Skewed? Where do most salaries cluster?**
  ...
  The distribution is primarily skewed to the right, with many of the salaries clustered within a standard deviation from the mean. The most common salary in this distribution is about 65,000 a year.
...
**How closely does the data follow the empirical rule? What does any deviation tell you about the distribution?**
  ...
  While this distribution slightly deviates from the empirical rule, it does follow it pretty closely. However, this does not mean that this is a normal distribution. Because the actual percentage is slightly off from the empirical rule, it is skewed to the right. 
...
**Write a sentence describing this probability in plain English. How does the normal approximation (prob_less) compare to the actual percentage?**
  ...
  This probability means that about 18.2% of White House salaries are more than $150,000 a year. The first value, which means that 16.9% of White House salaries are more than $150,000 is based on a if the salaries were normally distributed. However, the second probability shows that this distribution is skewed to the right because more salaries are greater than $150,000 a year. 
...
About 32.6% of White House salaries fall in between $80,000 and $120,000 a year, while the expected number is about 36.6%. This means that the White House salary structure is not perfectly normally distributed. Based on the data, more White House employees earn salaries below $80,000, rather than more than $120,000. 
...
The most significant difference between the expected and observed counts is for White House salaries between $60k-90k. This could be because there are many assistant positions within the White House and this is a typical salary for this type of job. Additionally, there are signifcantly less observed White House salaries below $60k compared to the expected number. This is likely because jobs paying below 60k are likely more entry level jobs, while White House employees need more experience to be hired to work there. 
...
Headline: White House salary data shows more high earners than expected 
Lede: About 18.2% of White House employees make more than $150,000 a year, while about 38.1% make between $60,000 and $90,000. 

I would use probability thinking to advance this story by comparing White House salaries to salaries nationally to get a better idea of how many people in the country make $150,000 a year. Additionally, I think it would be good to include more information about the proportion of employees making more than $150,000 a year to the rest of the White House staff. 
