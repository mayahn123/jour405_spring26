...
```{r}
umd_fees_pct2425 <- umd_fees |> mutate(pct_change = (`Fall 2025`- `Fall 2024`)/`Fall 2024` * 100)
```
...
Between 2024-2025, UMD total fees have increased by about 4.5%, while they have increased about 18.4% between 2021-2025. It could be interesting to see exactly where this funding is going, especially in that funding for student activities has increased by about 14.5% in a year. The most signficant increase in funding was for student sustainability, at 150% over 4 years. 
