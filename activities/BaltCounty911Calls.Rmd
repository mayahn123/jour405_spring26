...
I noticed that the number of drug overdose calls is lower at Jan. 2023 than it is at Jan. 2022. I also noticed that there is an uptick in calls in Oct. 2022 and a drop right before July 2022. I would draw lines to see the average number of calls per day and compare them with the outliers. 
...
This chart makes it much easier to see how many outliers there are in this data set. This allows me to better identify the number of unusually high or unusually low drug overdose calls received by Baltimore police. This also helps me compare the number of outliers per month and see how the time of year impacts the number of overdose calls. 
...
Baltimore County Police received 23 drug overdose calls on Oct. 4, 2022, which is greater than the usual daily number. 
...
I think the most important aspect of our analysis is that two of the days with the highest number of calls occurred within the same week of each other (July 14, 2022 and July 22, 2022). I think my next step would be to see if there were any bad batches of drugs that were laced with fentanyl. This would likely contribute to the high number of drug overdoses in such a short amount of time. 
I also thought it was interesting that News Year's Day has one of the highest number of overdose calls. While this does make sense because people tend to party more on New Year's, I think it would be interesting to see how first reponders prepare for days where they are expecting high numbers of emergencies. 
